...
<body>
  ...
  <div class="container mt-3">
    <div class="row">
      <form method="POST" action="./Task2Action.php">
        <div class="mb-3 mt-3">
        ...
        <div class="invalid-feedback">You need to complete all the input before submit !</div>
      </form>
      <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($name == null || $studyProgram == null) {
          // Display a warning because the input is empty
          echo '<div class="alert alert-danger mt-3">
          <strong>!!</strong> You need to complete all the input before submit <strong>!!</strong></div>';
        } else {
          // Display the Name & Study Program
